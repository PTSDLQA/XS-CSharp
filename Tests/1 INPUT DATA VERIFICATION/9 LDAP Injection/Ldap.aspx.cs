...
namespace Mopas.Tests
{
    ...
    public partial class Ldap : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // FP: AI issue #9, Medium, XSS, http://desktop-9pr2t70/#/taskResults/9
            ...
            // VERIFY: AI issue #8, Medium, XSS, http://desktop-9pr2t70/#/taskResults/8
            // GET /Tests/1%20INPUT%20DATA%20VERIFICATION/9%20LDAP%20Injection/Ldap.aspx.cs?name=%3cscript%3ealert(1)%3c%2fscript%3e HTTP/1.1
            // Host: localhost
            Response.Write(name);
            ...
            // VERIFY: AI issue #7, Medium, XSS, http://desktop-9pr2t70/#/taskResults/7
            // GET /Tests/1%20INPUT%20DATA%20VERIFICATION/9%20LDAP%20Injection/Ldap.aspx.cs?name=%3cscript%3ealert(1)%3c%2fscript%3e HTTP/1.1
            // Host: localhost
            Response.Write("name");
            ...
            // FIXED: AI issue #6, Medium, XSS, http://desktop-9pr2t70/#/taskResults/6
            // GET /Tests/1%20INPUT%20DATA%20VERIFICATION/9%20LDAP%20Injection/Ldap.aspx.cs?name=%3cscript%3ealert(1)%3c%2fscript%3e HTTP/1.1
            // Host: localhost
            Response.Write(name);
        }
